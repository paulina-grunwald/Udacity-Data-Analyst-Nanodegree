...
##Introduction
******
In this project for creating my visualization I will use Titanic dataset which contains information of 891 passangers out of 2224 passangers and crew on board of the Titanic. The dataset contains information such as passangers' age, sex, embarkment location, in which class were they located, ticket price etc. The purpose of my data visualization is primarily to show which passangers had higher chance to survive looking at the sex, class, embarkment and age variables. As can be seen from the visualization, most males and third class passengers did not survive the disaster.
...
##Design
******
In order to create the data visualization, I have started first with the investigation of the data. I have tried to choose the most important data categories associated with the Titanic passangers. In my opinion the most important are Sex, Class and Age. I believe that they had the biggest impact on the chance of survival of the passangers. For my investigation i have chosen bar plot as in my opinion.

For bar color selection i have used colorbrewer2.org. I wanted to use colorblind safe color scheme. I have chosen qualitative Dark2 palette. To visualize survived passangers I have chosen green color (color of life) and for perished passangers red color. The color and the order of axis are keep consistent over different charts.

I have decided to create bar plots including age, sex and class. The first plot represents survival rate by sex. I wante to show that men had much small survival chance in comparision to woman. The second and third plot represents survivalrte by group. In the second plot I separated the passaners into adults and children (<=18 years old). On the third plot i presented survival rate of passangers in 8 different age groups (0-10, 11-20, 21-30, 41-50, 51-60, 61-70, 71-80 ). I have also added the button that changes the y axis to procent and then back to count. I did that in order to see exact procentages of survived and persihed passangers in all age groups (for example it was difficoult to see exacly the ratio of survivols to persi ed in last rwo age groups). On the fourth plot i have explored survival rate by class. I wanted to show that passangers in the third class were the most affected. On the fifth plot i added another layer to the fourth plot which was sex data. 

##Feedback
******

After finishing my virst visualization (the visualization can be viewved at http://bl.ocks.org/paulina-grunwald/4914047cebb29ad0227fe086f164cf59) I posted it in the Udacity website forum as well as Google+ Udacity group to get feedback from fellow students. I used the questions provided as guidance to ask for specific feedback such as:
...
>Your Visualization looks good!
>I want to know which age group and which gender was more successful to get survived. In the left bar chart I can conclude that >female passengers had >priority to be survived rather than male passengers. In the right bar chart, I cannot say for sure that >children or adults had priority to be survived. If >you are able to compare the proportions then we would be able to say which age >group had higher survival rate. For example if you compare the proportions >of the survived people in each age group through the >stacked percent bar chart then I think we can make better conclusions.

Feedback from xueming_663398266218 (Udacity data analyst forum):
>The visualisation is very clean with nice colour, the story you want to tell is also clear for me. 
>Only one minor question: In the last figure, you used PctAxis as the y axis, while you used counts for the other charts, is there >a special reason?
...
>I really appreciated the overall contextualization you gave, leveling everyone's knowledge about the story. I agree with Yannis' >observations. The label >"Survived: Perished" was a bit confusion also. I found it interesting the conclusions about which sex and >class had a higher survival rate. I don't know >why the embarking location would be important, though. That's all, congrats!

##Post-feedback
******
Following the feedback from the 4 different udacity students, I have implemented the changes in my visualization:

- added 2nd age group bar plot to show exacly people in which age group had the highest chance of survival,
- added buttons that change y Axis to procent and back to count for plot 3 (age group plot)
- added titles and corrected y and x axis names for all plots
- removed plot with embarked location information as it didn't serve very well the story i was trying to convey,
- changed the colours of the plots to the ones that are more colorblind friendly (i have used Colorbrewer to find new colors).

Improved visualization can be accessed at: 
