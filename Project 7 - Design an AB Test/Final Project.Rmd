...
- Net conversion should not decrease.If the net conversion decreases then the experiment should not be launch. If on the other case net conversion stays the same or increases this would mean that we can launch out expderiment.
- Retnetion as net conversion should not decrease.If it decreases then the experiment should not be launch. If on the other case net conversion stays the same or increases this would mean that we can launch out expderiment
...
Net conversion has p value of 0.6776 which is much more higher than alpha level. This mean that this metric is not statistically significant. 
...
On the other net conversion decreased as well but not by statistically signigicant value. This means that the number of students that enrolled in the course after finishing 14 days trial was reduced. This could have been caused by the fact that students realized that they do not have enought time to continue with the study. They probably understood during the 14 days trial that the estimated time required for the course (that was mentioned in the screener) was accurate. Whe dropping rate of net conversion (which could have been caused by screener) is exacly what we did not want. This result does not support previously stated hypothesis (the sign test result was that gross conversion was significant and net conversion was not). 
